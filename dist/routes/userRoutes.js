 ...
 */
router.post("/logout", authMiddleware_1.protect, authController.logout);
/**
 * @swagger
 ...
 *                     $ref: '#/components/schemas/User'
 */
router.get("/", authMiddleware_1.protect, userController.getAllUsers);
/**
 * @swagger
 * /api/v1/users/{id}:
 *   get:
 ...
 *                   $ref: '#/components/schemas/User'
 */
router.get("/:id", authMiddleware_1.protect, userController.getUserById);
/**
 * @swagger
 * /api/v1/users/{id}:
 *   put:
 ...
 *                   example: success
 */
router.put("/change-password", authMiddleware_1.protect, authController.changePassword);
/**
 * @swagger
